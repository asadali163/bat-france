# SELL_DATA = "./data/raw/combined_df.csv"


SELL_DATA = "http://192.168.99.122:8000/combined_df.csv"
WEATHER_CSV = "./data/raw/weather_till_march2.csv"
EVENTS_DATA = "./data/raw/events_batch2.csv"
